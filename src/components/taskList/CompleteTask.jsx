...
const CompleteTask = ({data}) => {
  return (
    <div className="flex-shrink-0 flex-nowrap w-full max-w-[300px] h-full bg-yellow-500 rounded p-5 text-center ">
      <div className="flex justify-between w-full items-center h-[20%] ">
        <h1 className="bg-yellow-400 font-bold text-xl px-4 py-2 rounded ">
          {data.category}
        </h1>
